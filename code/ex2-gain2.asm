/*
Program gain2 is a simple inout program but reduces the gain on the left channel by 4 dB, (i.e. 0.631) 
using a command to the codec

Author: Patrick Gaydecki (modified by Haseeb Malik, Jakub Mandula, Tarig Mustafa, Kevin Golan - Modied line 48)
Date  : 15.10.2017 (modified 5/3/19)
*/
...
R1=0xd7(X); R0=0x4023(X); call TWI_write; // Set left headphone volume to -4 dB 
