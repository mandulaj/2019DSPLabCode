/*
Program filter1 is a single MAC FIR filtering program. It reads in a file of coefficients created by Signal Wizard.
...
I0=0x11800000; B0=I0; L0=P0;
I1=0x11900000; B1=I1; L1=P0;

P0 = length(filter)-1;									// Sets P0 to the number of coeffs in the filter minus 1 (one n-1 are done in the loop)
